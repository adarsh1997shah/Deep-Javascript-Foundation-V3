 ...
 * For `this.teacher`, note that arrow func doesnt have its own `this` so it takes `this` lexically means it searches for `this` in the above scope as any other variable.
...
// NOTE: If new used on arrow func you get exception as to you cannot use new keyword with arrow func.

 ...
 * A function's `this` references the execution context for that call, determined entirely by how the function is called.
 ...
 * NOTE: there are 4 different ways in which a function can be invoked, but many different ways a function can be defined.
   - nameSpace pattern (the dot notation).
	 - the call, apply and bind way.
	 - the new keyword.
	 - plain normal func call (Default)
 */
